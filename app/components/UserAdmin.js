...
function roleBadgeClass(role) {
  const r = String(role || "").toLowerCase();
  return r === "admin" ? "badge badgeAdmin" : "badge badgeViewer";
}
                    ...
                    <tr key={u.id}>
                      <td>
                        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                          ...
                          {isMe ? <span className="badge badgeViewer">tú</span> : null}
                        </div>
                      </td>
                      <td>
        ...
        {createOpen ? (
            <div className="modalOverlay" onMouseDown={() => !createBusy && setCreateOpen(false)}>
              ...
              <style jsx>{`
                ...
                .modal .h2 { color: rgba(255, 255, 255, 0.96); }
                .modal .p { color: rgba(226, 232, 240, 0.78); }
                .modal .label { color: rgba(226, 232, 240, 0.88); }
                .modal .input {
                  background: rgba(255, 255, 255, 0.08);
                  border-color: rgba(255, 255, 255, 0.14);
                  color: rgba(255, 255, 255, 0.92);
                }
                .modal .input::placeholder { color: rgba(226, 232, 240, 0.55); }
                .modal .btn {
                  background: rgba(255, 255, 255, 0.08);
        ...
        {editOpen && editUser ? (
            <div className="modalOverlay" onMouseDown={() => !editBusy && setEditOpen(false)}>
                ...
                <div className="modalBody">
                  ...
                  <label className="row" style={{ gap: 10, alignItems: "center" }}>
                    <input
                        ...
                        disabled={String(editUser.role || "").toLowerCase() === "admin" && adminCount <= 1}
                    />
                    <span style={{ fontWeight: 700 }}>Permiso para Admin</span>
                    {String(editUser.role || "").toLowerCase() === "admin" && adminCount <= 1 ? (
                        <span className="badge badgeViewer" title="No puedes quitar el último admin">último admin</span>
                    ) : null}
                  </label>
              ...
              <style jsx>{`
                ...
                .modal .h2 { margin: 0; color: rgba(255, 255, 255, 0.96); }
                .modal .p {
                  margin: 6px 0 0;
